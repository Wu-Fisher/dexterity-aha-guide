...
- [3. 灵巧操作算法🧠](#3-灵巧操作算法)
  ...
  - [3.2 模仿学习流派](#32-模仿学习流派)
    ...
    - [3.2.6 Embodied Agent 参考文献](#326-embodied-agent-参考文献)
...
11. RobustDexGrasp 一种基于单视角视觉输入的零样本灵巧抓取方法，通过局部距离向量构建手-物体交互表示。方法结合模仿学习和强化学习，提升对动态扰动和感知噪声的鲁棒性。[[论文](https://arxiv.org/pdf/2504.05287)]
